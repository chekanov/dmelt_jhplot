 ...
 */
    public void paint(Graphics g) {
        int i;
        VectorGraphics lg  = VectorGraphics.create(g);
 ...
 */
        protected Rectangle ForceSquare(VectorGraphics g, Rectangle r) {
            Axis a;
            Rectangle dr;
            int x      = r.x;
            int y      = r.y;
 ...
 */
       ...
       protected Rectangle getDataRectangle(VectorGraphics g, Rectangle r) {
            Axis a;
            int waxis;
            int x     = r.x;
            int y     = r.y;
 ...
 */
        protected Rectangle drawAxis(VectorGraphics g, Rectangle r) {
            Axis a;
            int waxis;
            Rectangle dr;
            int x;
