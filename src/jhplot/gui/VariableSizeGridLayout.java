...
// http://www.javaworld.com/article/2077486/core-java/java-tip-121--flex-your-grid-layout.html

public class VariableSizeGridLayout extends GridLayout 

{

  public VariableSizeGridLayout() {
  ...
  public VariableSizeGridLayout(int rows, int cols) {
  ...
  public VariableSizeGridLayout(int rows, int cols, int hgap, int vgap) {
