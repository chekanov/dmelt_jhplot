...
/**
 * This has been modified so that other classes can extend it and modify the
 * mouse behaviour. It is just the ChartPanel code with "private" replaced by
 * "public". A Swing GUI component for displaying a {@link JFreeChart} object.
 * <P> The panel registers with the chart to receive notification of changes to
 * any component of the chart. The chart is redrawn automatically whenever this
 * notification is received.
 */
public class BaseChartPanel extends JPanel implements ChartChangeListener, ChartProgressListener, ActionListener, MouseListener, MouseMotionListener, Printable, Serializable
{
	 ...
	 *            for the chart.
	 */
	public BaseChartPanel(JFreeChart chart, boolean properties, boolean save, boolean print, boolean zoom, boolean tooltips)
	{
	 ...
	 *            for the chart.
	 */
	public BaseChartPanel(JFreeChart chart, int width, int height, int minimumDrawWidth, int minimumDrawHeight, int maximumDrawWidth, int maximumDrawHeight, boolean useBuffer, boolean properties, boolean save, boolean print, boolean zoom, boolean tooltips)
	{
		...
		// initialize BaseChartPanel-specific tool tip delays with
	...
	/**
	 * Returns the minimum drawing height for charts. <P> If the height
	 * available on the panel is less than this, then the chart is drawn at the
	 ...
	 * time the chart is drawn on the panel, if the available height is less
	...
	/**
	 * Returns the maximum drawing height for charts. <P> If the height
	 * available on the panel is greater than this, then the chart is drawn at
	 * the maximum height then scaled up to fit.
	 * 
	 ...
	 * 
	 * @param flag
	 *            <code>true</code> enables zooming and rectangle fill on
	 *            zoom.
	 */
	 ...
	 * 
	 * @param flag
	 *            <code>true</code> enables trace lines for the mouse pointer
	 ...
	 * 
	 * @param flag
	 *            <code>true</code> to enable tooltips, <code>false</code>
	 *            to disable tooltips.
	 */
	 ...
	 * 
	 * @param flag
	 *            <code>true</code> indicate, that the buffer should be
	 *            refreshed.
	 */
	...
	public void mouseDragged(MouseEvent e)
	{
		...
		if(this.popup != null && this.popup.isShowing()) { return; }
		// if no initial zoom point was set, ignore dragging...
		if(this.zoomPoint == null) { return; }
	...
	public void calulateSelectionRectangle()
	{
	...
	{
		if(listener == null) { throw new IllegalArgumentException("Null 'listener' argument."); }
	...
	public void setZoomRectangle(Rectangle2D zoomRectangle)
	{
