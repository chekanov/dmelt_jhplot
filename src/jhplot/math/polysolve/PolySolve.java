...
* For a given data set of x,y pairs, a polynomial regression of this kind can be generated: <p> 
*
*    f(x)=c0+c1x+c2x2+c3x3... 
* <p> 
* In which c0,c1,c2... represent coefficients created by a mathematical procedure described in detail here.
*
...
public final class PolySolve extends javax.swing.JApplet {
    ...
    protected String nameVersion = "PolySolve";
    protected String copyright = "Copyright \251 2012,2015 P.Lutus,S.Chekanov";
    protected Color gridColor = new Color(192, 240, 192);
    ...
    protected double dotScale = 4.0;
    protected String pageData;
    protected String errorMsg = "";
    protected boolean data_valid = false;
    protected  int poly_order = 2; // default order
    protected   double xmin, xmax, ymin, ymax;
    protected  double dataXmin, dataXmax;
    protected  double dataYmin, dataYmax;
    protected  double eps;
    protected int listingForm = 0;
    protected  boolean error;
    protected  boolean reverseMode = false;
    protected String defaultData = "-1 -1\n" + "0 3\n" + "1 2.5\n" + "2 5\n" + "3 4\n" + "5 2\n" + "7 5\n" + "9 4\n";
   ...
   */
   public PolySolve(P1D input) {
      ...
      BuildPolySolve(input.getArrayX(), input.getArrayY());
   ...
   */
   public void BuildPolySolve(double[] xx, double[] yy ) {
    ...
    for (int j=0; j<xx.length; j++){
                        userDataList.add(new Pair(xx[j], yy[j]));
                        defaultData = defaultData + Double.toString(xx[j])+" "+Double.toString(yy[j])+"\n";
    } 
    }
       ...
       // PolySolve theApplet = new PolySolve();
        applet = false;
        theFrame = new JFrame(nameVersion);
        theFrame.addWindowListener(new FrameListener());
        theFrame.setSize(700, 800);
        // theFrame.add("Center", theApplet);
        init();
...
*/
    ...
    private void initComponents() {
      ...
      //  theFrame.add(mainPanel, gridBagConstraints);
          theFrame.add("Center",mainPanel);
