...
public class ColorModelSet implements SurfaceColor
{
	...
	protected  Color lineboxColor=Color.BLACK; // Color.getHSBColor(0f,0f,0.5f);
	...
	public ColorModelSet()
	{
		...
		*/
		...
		opaque= new ColorModel(			ColorModel.OPAQUE	,	RED_S	,	0.1f	,	1f		,	0f		,	0f		);
	...
	/* (non-Javadoc)
	 * @see surfaceplotter.SurfaceColor#getBackgroundColor()
	 */
	public Color getBackgroundColor(){return bkgColor;}
	/* (non-Javadoc)
	 * @see surfaceplotter.SurfaceColor#getLineBoxColor()
	 */
	public Color getLineBoxColor() {return lineboxColor;}
	/* (non-Javadoc)
	 * @see surfaceplotter.SurfaceColor#getBoxColor()
	 */
	public Color getBoxColor() {return boxColor;}
	/* (non-Javadoc)
	 * @see surfaceplotter.SurfaceColor#getLineColor()
	 */
	public Color getLineColor(){return lineColor;}
	/* (non-Javadoc)
	 * @see surfaceplotter.SurfaceColor#getTextColor()
	 */
	...
	/* (non-Javadoc)
	 * @see surfaceplotter.SurfaceColor#getLineColor(int, float)
	 */
	...
	/* (non-Javadoc)
	 * @see surfaceplotter.SurfaceColor#getPolygonColor(int, float)
	 */
	...
	/* (non-Javadoc)
	 * @see surfaceplotter.SurfaceColor#getFirstPolygonColor(float)
	 */
	...
	/* (non-Javadoc)
	 * @see surfaceplotter.SurfaceColor#getSecondPolygonColor(float)
	 */
