...
public class Slicing {
     ...
     *            Matrix to slice.
     * @param n
     *            Array of number of slices per dimension of the matrix.
     * @param bounds
     *            type of bounds setting : AUTO or UNIFORM.
     */
     ...
     *            Matrix to slice.
     * @param bounds
     *            bounds of slices per dimension (in rows!).
     */
     ...
     *            Matrix to slice.
     * @param centers
     *            centers of slices per dimension (in rows!).
     * @param widths
     *            widths of slices per dimension (in rows!).
     */
    ...
    // public double[][] getSlicesSigmaCardinals() {
    // AbstractMatrix cards = new Matrix(slice.length, 1);
    // for (int i = 0; i < slice.length; i++) {
    // cards.set(i, 0, slice[i].cardinal);
    // }
    // return cards;
    // }
    ...
    private class Slice {
        ...
        public boolean isIn(double[] x) {
            ...
            for (int j = 0; j < x.length; j++) {
                ...
                boolean inj = ((Math.abs(x[j] - center[j]) - width[j] / 2) <= epsilon);
