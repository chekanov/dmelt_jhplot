...
public class RootHistogramAdapter
{
   ...
   public  static class Root1DHistogramAdapter extends Root1HistogramAdapter
   {
      private TH1D th1d;
   ...
   public  static class Root1FHistogramAdapter extends Root1HistogramAdapter
   {
      private TH1F th1f;
   ...
   public  static abstract class Root1HistogramAdapter implements Rebinnable1DHistogramData, HasStatistics, Statistics
   {
   ...
   public static class Root2DHistogramAdapter extends Root2HistogramAdapter
   {
      private TH2D th2d;
   ...
   public  static class Root2FHistogramAdapter extends Root2HistogramAdapter
   {
      private TH2F th2f;
   ...
   public  static abstract class Root2HistogramAdapter implements Rebinnable2DHistogramData, HasStatistics, Statistics
   {
