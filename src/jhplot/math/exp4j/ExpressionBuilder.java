...
package jhplot.math.exp4j;

import java.util.*;

import jhplot.math.exp4j.function.Function;
import jhplot.math.exp4j.function.Functions;
import jhplot.math.exp4j.operator.Operator;
import jhplot.math.exp4j.shuntingyard.ShuntingYard;
...
public class ExpressionBuilder {
    ...
    /**
     * Add a {@link jhplot.math.exp4j.function.Function} implementation available for use in the expression
     * @param function the custom {@link jhplot.math.exp4j.function.Function} implementation that should be available for use in the expression.
    ...
    /**
     * Add multiple {@link jhplot.math.exp4j.function.Function} implementations available for use in the expression
     * @param functions the custom {@link jhplot.math.exp4j.function.Function} implementations
     * @return the ExpressionBuilder instance
     */
    ...
    /**
     * Add multiple {@link jhplot.math.exp4j.function.Function} implementations available for use in the expression
     * @param functions A {@link java.util.List} of custom {@link jhplot.math.exp4j.function.Function} implementations
     * @return the ExpressionBuilder instance
     */
    ...
    /**
     * Add an {@link jhplot.math.exp4j.operator.Operator} which should be available for use in the expression
     * @param operator the custom {@link jhplot.math.exp4j.operator.Operator} to add
     * @return the ExpressionBuilder instance
     */
    ...
    /**
     * Add multiple {@link jhplot.math.exp4j.operator.Operator} implementations which should be available for use in the expression
     * @param operators the set of custom {@link jhplot.math.exp4j.operator.Operator} implementations to add
     * @return the ExpressionBuilder instance
     */
    ...
    /**
     * Add multiple {@link jhplot.math.exp4j.operator.Operator} implementations which should be available for use in the expression
     * @param operators the {@link java.util.List} of custom {@link jhplot.math.exp4j.operator.Operator} implementations to add
     * @return the ExpressionBuilder instance
     */
