...
*****************/
   ...
   */
     public int getRWidth(VectorGraphics  g) {
   ...
   */
     public int getRHeight(VectorGraphics g) {
   ...
   * @return the Left edge of the rotated text
   */
     public int getLeftEdge(VectorGraphics g) {
   ...
   * @return the Right edge of the rotated text
   */
     public int getRightEdge(VectorGraphics g) {
   ...
   * @return the Top edge of the rotated text
   */
     public int getTopEdge(VectorGraphics g) {
   ...
   * @return the Bottom edge of the rotated text
   */
     public int getBottomEdge(VectorGraphics g) {
   ...
   * @return the Left edge of the rotated text
   */
     public int getLeftEdge(VectorGraphics g, int j) {
   ...
   * @return the Right edge of the rotated text
   */
     public int getRightEdge(VectorGraphics g, int j) {
   ...
   * @return the Top edge of the rotated text
   */
     public int getTopEdge(VectorGraphics g, int j) {
   ...
   * @return the Bottom edge of the rotated text
   */
     public int getBottomEdge(VectorGraphics g, int j) {
   ...
   */
     public void draw(VectorGraphics g, int x, int y) {
   ...
   */
     public void draw(VectorGraphics g, int x, int y, int j) {
   ...
   * @param y pixel position of the text
   */
     public synchronized void draw(Component comp, VectorGraphics g, int x, int y) {
         TextState ts;
         int xoffset = 0;
         int yoffset = 0;
         Image    offsI        = null;
         VectorGraphics offsG        = g;
